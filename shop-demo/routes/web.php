...
Route::prefix('cart')->group(function () {
    ...
    Route::post('/remove/{id}', [CartController::class, 'remove'])->name('cart.remove'); // Giữ nguyên POST
});
...
Route::prefix('checkout')->group(function () {
    // Nếu có trang hiển thị form checkout thì giữ dòng này
    Route::get('/', [CheckoutController::class, 'index'])->name('checkout');

    // Route xử lý thanh toán khi nhấn “Thanh toán”
    Route::post('/', [CheckoutController::class, 'process'])->name('checkout.process');

    // Route xử lý “Mua ngay”
    ...
    Route::middleware('auth')->prefix('profile')->group(function () {
        ...
        Route::delete('/destroy', [ProfileController::class, 'destroy'])->name('profile.destroy'); // Thêm route này
    });
